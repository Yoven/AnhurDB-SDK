...
// SearchHitSignals is optional per-hit ablation debug (fts/semantic/simhash
// ranks, RRF score, semantic cosine) mirroring server/model.SearchHitSignals
// field-for-field. Never calibrated similarity — for measurement only.
