...
TypeScript SDK for [AnhurDB](https://anhurdb.com) — cognitive memory for AI agents.
...
```typescript
// Store a memory (auto-embedding on cloud, FTS5 on OSS)
...
// Smart search (DuckDB + cognitive weight boosting)
...
| `url`      | `string` | `https://api.anhurdb.com`   | Server URL                      |
